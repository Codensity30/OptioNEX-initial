        ...
        <div className="max-w-6xl mx-8 md:mx-10 lg:mx-20 xl:mx-auto">
          <div className="transition duration-500 ease-in-out transform scale-100 translate-x-0 translate-y-0 opacity-100">
            <div className="mb-12 space-y-5 md:mb-16 md:text-center">
              <div className="inline-block px-3 py-1 text-sm font-semibold text-indigo-100 rounded-lg md:text-center text-cn bg-[#202c47] bg-opacity-60  hover:bg-opacity-40">
                Words from Others
              </div>
              <h1 className="mb-5 text-3xl font-semibold text-white md:text-center md:text-5xl font-Poppins">
                It's not just us.
              </h1>
              <p className=" text-gray-100 md:text-center md:text-lg font-Raleway">
                Join the buzz and see why everyone is talking about us! Read
                reviews and get hooked.
              </p>
            </div>
          </div>
                  ...
                  <div className="relative p-6 space-y-6 leading-none rounded-lg bg-slate-800 ring-1 ring-gray-900/5">
                    <div className="flex items-center justify-between">
                      ...
                      <svg
                        ...
                        fill="currentColor"
                        className="inline-block w-8 h-8 text-gray-500"
